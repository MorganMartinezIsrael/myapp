...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    {!!Form::open(array('url'=>'borrar_ferreteria/'.$registro_eliminar->id,'method'=>'PUT','autocomplete'=>'off'))!!}
    ...
    {!!form::submit('Borrar',['name'=>'grabar','id'=>'grabar','content'=>'<span>Borrar</span>'])!!}
